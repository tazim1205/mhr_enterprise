				...
				<div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
						...
						<div class="card">
							<div class="card-body">
								<div class="m-sm-3">
									<form method="post" action="{{route('user.submit_email')}}" enctype="multipart/form-data">
                                        @csrf
										<div class="mb-3">
											<label class="form-label">@lang('user.email')</label>
											<input class="form-control form-control-lg" type="email" name="email" placeholder="" />
										</div>
										<div class="d-grid gap-2 mt-3">
											<button type="submit" class='btn btn-lg btn-primary'>@lang('user.send_code')</button>
										</div>
									</form>
								</div>
							</div>
