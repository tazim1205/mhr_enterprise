    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('price_range.store')}}" method="post" enctype="multipart/form-data" id="formData">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
                                    <label for="from">@lang('price_range.from')</label><span class="text-danger">*</span>
                                    <input type="text" name="from" class="form-control  mt-1 @error('from') is-invalid @enderror" id="from" value="{{old('from')}}" required>
                                    @error('from')
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
                                    ...
                                    <input type="text" name="to" class="form-control  mt-1  @error('to') is-invalid @enderror" id="to" value="{{old('to')}}" required>
                                    @error('to')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
