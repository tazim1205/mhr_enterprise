    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('sub_categorie.store')}}" method="post" enctype="multipart/form-data" id="formData">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-12 mt-2">
                                    ...
                                    <select class="form-control" name="cat_id" required>
                                        ...
                                        <option value="{{$v->id}}">@if(config('app.locale') == 'en'){{$v->cat_name_en}}
                                            @else@if(config('app.locale') == 'bn'){{$v->cat_name_bn}}@endif</option>
                                        @endforeach
                                        @endif
                                    </select>
                                    @error('cat_id')
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 mt-2">
                                    <label for="sub_cat_name_en">@lang('sub_categorie.sub_cat_name_en')</label><span class="text-danger">*</span>
                                    <input type="text" name="sub_cat_name_en" class="form-control  mt-1 @error('sub_cat_name_en') is-invalid @enderror" id="sub_cat_name_en" value="{{old('sub_cat_name_en')}}" required>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 mt-2">
                                    ...
                                    <input type="text" name="sub_cat_name_bn" class="form-control  mt-1  @error('sub_cat_name_bn') is-invalid @enderror" id="sub_cat_name_bn" value="{{old('sub_cat_name_bn')}}">
