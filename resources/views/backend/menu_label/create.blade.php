    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('menu_label.store')}}" method="post" enctype="multipart/form-data" id="formData">
                            @csrf
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                                <label for="order_by">@lang('common.sl')</label><span class="text-danger">*</span>
                                <input type="number" name="order_by" class="form-control  mt-1 @error('order_by') is-invalid @enderror" id="order_by" value="{{old('order_by')}}">
                                @error('order_by')
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
                                ...
                                <input type="text" name="label_name_en" class="form-control  mt-1 @error('label_name_en') is-invalid @enderror" id="label_name_en" value="{{old('label_name_en')}}">
                                @error('label_name_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 mt-2">
                                ...
                                <input type="text" name="label_name_bn" class="form-control  mt-1" id="label_name_bn" value="{{old('label_name_bn')}}">
                            </div>
