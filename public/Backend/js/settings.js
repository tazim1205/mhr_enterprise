        ...
        function () {
            ...
            const c = () => {
                let lang = $('html').attr('lang');
                    ...
                    if(lang == 'en')
                    {
                        color_schem = 'Color Scheme';
                        settings = 'Settings',
                        scheme_title = 'The Perfect Color To Apply In Your App';
                    }
                    else
                    {
                        color_schem = 'কালার স্কীম';
                        scheme_title = 'আপনার সফটওয়্যারে কালার দিন';
                        settings = 'সেটিংস';
                    }
