...
<main class="content">
    <div class="container-fluid p-0">
        ...
        @if(Auth::user()->can('messages trash'))
        {{-- for deleted list index --}}
        @slot('deleted_list_btn_name')
        @lang('messages.deleted_list')
        @endslot
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            $onlyTrashed = message::onlyTrashed()->get();
                            @endphp
                                ...
                                <table id="datatable-roles-deleted" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$v->phone}}</td>
                                            <td>
                                                <a href="{{url('retrive_message')}}/{{$v->id}}" class="btn btn-warning btn-sm"><i class="fa fa-rotate-right"></i> Retrive</a>
                                                <a onclick="return Confirm()" href="{{url('permenantMessageDelete')}}/{{$v->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Permenantly Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        @endif
