...
<main class="content">
    <div class="container-fluid p-0">
        ...
        @php
        Use App\Traits\Date;
        $result = App\Traits\Date::explodeDateTime(' ',$data['branch']->created_at);
        @endphp
